INSERT INTO `posts`
    (`room_id`,`message`,`attachment_name`,`is_deleted`,`posted_at`,`post_user_id`,`updated_at`,`update_user_id`)
    VALUES
    ...
    (2,'よおｒしくおねがいします！',NULL,1,'2020/04/24 13:42:03',3,'2020/04/24 13:42:03',3),
